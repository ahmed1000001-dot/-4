...
public class MainActivity extends Activity{
 ...
 public class Bridge{
  ...
  @JavascriptInterface public long addSupplierReturn(String d,long s,double a,String n){return db.addSupplierReturn(d,s,a,n);}@JavascriptInterface public int updateSupplierReturn(long id,String d,long s,double a,String n){return db.updateSupplierReturn(id,d,s,a,n);}@JavascriptInterface public int deleteSupplierReturn(long id){return db.deleteSupplierReturn(id);}
  ...
  @JavascriptInterface public void exportBackup(){pending=db.backup();runOnUiThread(()->{Intent i=new Intent(Intent.ACTION_CREATE_DOCUMENT);i.addCategory(Intent.CATEGORY_OPENABLE);i.setType("application/json");i.putExtra(Intent.EXTRA_TITLE,"canteen-pro-v5.0-backup.json");startActivityForResult(i,EXP);});}
